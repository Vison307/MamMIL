...
class SRMamba2(nn.Module, PyTorchModelHubMixin):
    def __init__(
        self,
        d_model,
        d_state=128,
        ...
        self.dt_b_bias = nn.Parameter(inv_dt_b)
        # Just to be explicit. Without this we already don't put wd on dt_bias because of the check
        # name.endswith("bias") in param_grouping.py
        self.dt_b_bias._no_weight_decay = True
    ...
    def forward(self, u, seqlen=None, seq_idx=None, cu_seqlens=None, inference_params=None):
        ...
        if self.use_mem_eff_path and inference_params is None:
            ...
            N, L, C = zxbcdt.shape
            zxbcdt_b = TransposeTokenReEmbedding.transpose_normal_padding(zxbcdt, rate=5)
            ...
            # 将序列转置，并删除padding的位置
            out_b = TransposeTokenReEmbedding.transpose_remove_padding(out_b, rate=5, length=L)
